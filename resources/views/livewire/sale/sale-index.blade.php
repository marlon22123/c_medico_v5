                                    ...
                                    <tbody class=" text-sm font-light">
                                        @foreach ($sales as $item)   
                                           ...
                                           {{--      <td class="py-3 px-6 text-left">
                                                ...
                                                <td class="py-3 px-6 text-center">
                                                    @if ($item->status == 1)
                                                        <span class="bg-blue-100 text-blue-800 text-xs  px-2.5 py-0.5 rounded  border border-blue-400">REGISTRADO</span>
                                                   
                                                    @endif
                                                    
                                                    @if( $item->status == 2)
                                                        <span class="bg-red-100 text-red-800 text-xs font-medium  px-2.5 py-0.5 rounded  border border-red-400">ANULADO</span>
                                                    @endif
                                                    @if ( $item->status == 3)
                                                    <span class="bg-green-100 text-green-800 text-xs font-medium  px-2.5 py-0.5 rounded border border-green-400">FACTURADO</span>
                                                ...
                                                <td class="py-3 px-6 text-center">
                                                    @if ($item->type == 1)
                                                        <span class="bg-blue-100 text-blue-800 text-xs  px-2.5 py-0.5 rounded  border border-blue-400">LIBRE</span>
                                             
                                                    @endif
                                                    
                                                    @if( $item->type == 2)
                                                        <span class="bg-yellow-100 text-yellow-800 text-xs font-medium  px-2.5 py-0.5 rounded  border border-yellow-400">TERCERO</span>
                                                    @endif
